...
Verified on 2026-09-26: schema export runs as `tools/contracts/export.mjs` and reads `birdify/scripts/contracts/models.mjs`. `tsconfig.tools.json` and the compiled exporter are gone. The removed tool compilation emitted 2 files (`.build-tools/tools/contracts/export.mjs` and `.build-tools/src/contracts/models.mjs`); that pass now emits 0. Schema bytes are unchanged. Typecheck, build parity, documentation checks, example validation, installation checks and 87 unit tests passed. No timing claim.
