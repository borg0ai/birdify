...
var mapPath = Type.String({ "minLength": 1, "maxLength": 500, "pattern": "^(?!/)(?!.*(?:^|/)(?:\\.\\.?|\\.git)(?:/|$))(?!.*//)(?!.*[\\\\:\\u0000-\\u001f\\u007f])[^/].*[^/]$|^[^./\\\\:\\u0000-\\u001f\\u007f]$" });
var mapId = Type.String({ "pattern": "^[a-z][a-z0-9-]{0,63}$" });
var mapText = Type.String({ "minLength": 1, "maxLength": 2e3, "pattern": "\\S" });
var mapQuestions = Type.Array(mapText, { "uniqueItems": true });
var mapTranslation = Type.Object({
...
var mapTranslations = Type.Record(Type.String({ pattern: "^[a-z]{2,3}(-[A-Za-z0-9]{2,8})*$" }), mapTranslation, { "minProperties": 1, "additionalProperties": false });
var mapEvidenceList = Type.Array(Type.Object({
  "path": mapPath,
  "note": mapText,
...
var mapLanguage = Type.String({ "pattern": "^[a-z]{2,3}(-[A-Za-z0-9]{2,8})*$", "maxLength": 35 });
var eventPaths = Type.Array(mapPath, { "uniqueItems": true });
var architectureSchema = Type.Object({
...
var activitySchema = Type.Object({
  "constraintReviews": Type.Optional(Type.Array(Type.Object({
    ...
    "evidence": Type.String({ "maxLength": 2e3 }),
...
var ajv = new import__.Ajv2020({ allErrors: true, strict: true, formats: { "date-time": true } });
var checkArchitecture = ajv.compile(architectureSchema);
var checkActivity = ajv.compile(activitySchema);
export {
  checkActivity,
  checkArchitecture
};
