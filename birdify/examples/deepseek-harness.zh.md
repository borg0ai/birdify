...
来源：[DeepSeek Harness 架构文档](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/docs/architecture.md)，作者 DeepSeek AI，采用 MIT 许可证。本概览独立编写，不是官方架构图，也未覆盖所有应用或插件。模块和关系声明均待源码核验；证据路径指向该仓库，不是 Birdify。
