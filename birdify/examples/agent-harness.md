...
This is a conceptual architecture for demonstrating Birdify, not a map of
Birdify's implementation or any particular coding agent. All `src/` ownership
