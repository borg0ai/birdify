...
(() => {
  ...
  try {
    storedLanguage = localStorage.getItem("birdify-language");
  } catch {
  }
  ...
  function applyLanguage() {
    ...
    document.title = `${localized2(map.project, "name")} | Birdify`;
...
${localized2(module, "responsibility")}`;
  ...
  languageSelect.onchange = () => {
    ...
    try {
      localStorage.setItem("birdify-language", language);
    } catch {
    }
  ...
  $("theme").onclick = () => {
    ...
    try {
      localStorage.setItem("birdify-theme", theme);
    } catch {
    }
    themeButton();
  };
