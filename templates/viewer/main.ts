import type { Architecture, ActivityEvent, Module, Relationship, Constraint } from '../../packages/core/src/contracts/models.js';
import { routeArchitecture } from './routing.js';
import * as BirdifyI18n from './i18n.js';
import { mountConstraintCanvas, type ConstraintCanvas } from './constraint-canvas.js';
import type { ConstraintFreshness, ConstraintGraph } from '../../packages/core/src/constraint-types.js';
declare const DATA: {
  map: Architecture;
